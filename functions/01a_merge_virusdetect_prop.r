...
option_list = list(
  make_option(c("-I", "--indir"), type="character", default="smallRNA/2018/03_smallRNA_tables/",
  ...
  make_option(c("-O", "--outfile"), type="character", default="tables/smallRNA_contigs_VirDet.txt",
              help="Fasta index file", metavar="character")
)
...
#Read prefix: 32_1 32_4 32_12
#Internal names: mont_neg_merged cort_gva_merged maln_lr3
#Names on paper: MO, U1, MN
