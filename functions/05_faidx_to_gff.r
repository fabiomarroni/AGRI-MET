...
option_list = list(
  make_option(c("-X", "--indexfile"), type="character", default="reference/vrl_plant.fai",
  ...
  make_option(c("-T", "--gtffile"), type="character", default="reference/vrl_plant_simple.gff", 
...
transcriptome_to_simple_gtf(indexfile=indexfile,gtffile=gtffile)
